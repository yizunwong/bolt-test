...
export default function TrustSecurityPage() {
  ...
  const complianceStandards = [
    ...
    {
      name: 'SOC 2 Type II',
      description: 'Service Organization Control certification for security and privacy',
      icon: Verified,
      details: [
  ...
  const privacyPrinciples = [
    ...
    {
      title: 'User Control',
      description: 'Full control over your personal data with easy export and deletion',
      icon: UserCheck
    },
    {
  ...
  const technicalArchitecture = [
    {
      ...
      description: 'Ethereum-based smart contracts for policy management and claims processing',
      icon: Layers,
      details: [
    ...
    },
    {
      ...
      description: 'Decentralized data feeds for real-world information and verification',
      icon: Globe,
      details: [
    ...
    },
    {
      ...
      description: 'Distributed storage for policy documents and supporting materials',
      icon: HardDrive,
      details: [
    ...
    },
    {
      ...
      description: '24/7 monitoring and alerting for system health and security',
      icon: RefreshCw,
      details: [
      ...
      <section className="relative overflow-hidden pt-24 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-12 max-w-4xl mx-auto">
            Learn how we protect your data, ensure compliance, and maintain the highest standards of security for your peace of mind.
          </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                Our multi-layered security approach ensures your data and funds are protected at all times
              </p>
            </div>
              ...
              {securityMeasures.map((measure, index) => (
                <Card key={index} className="glass-card rounded-2xl card-hover">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-3">{measure.title}</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-6">{measure.description}</p>
            ...
            <div className="mt-16 p-6 bg-blue-50/50 dark:bg-blue-900/20 rounded-2xl border border-blue-200 dark:border-blue-800">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-blue-800 dark:text-blue-200 mb-2">Our Security Commitment</h3>
                  <p className="text-blue-700 dark:text-blue-300 mb-4">
                    At BlockSecure, security is our highest priority. We employ a defense-in-depth approach with multiple layers of protection to safeguard your data and funds. Our security team continuously monitors for threats and vulnerabilities, and we regularly conduct third-party security audits to ensure our systems remain impenetrable.
                  </p>
                  <p className="text-blue-700 dark:text-blue-300">
                    We maintain a comprehensive bug bounty program and encourage security researchers to responsibly disclose any vulnerabilities they discover. This collaborative approach helps us maintain the highest security standards in the industry.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                We adhere to the highest regulatory standards across global jurisdictions
              </p>
            </div>
                ...
                <Card key={index} className="glass-card rounded-2xl card-hover">
                  <CardContent className="p-8">
                    <div className="flex items-center space-x-4 mb-6">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100">{standard.name}</h3>
                        <p className="text-slate-600 dark:text-slate-400">{standard.description}</p>
                      </div>
                    </div>
                ...
                {certifications.map((cert, index) => (
                  <Card key={index} className="glass-card rounded-2xl">
                    <CardContent className="p-4 text-center">
                      ...
                      <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-1">{cert.name}</h4>
                ...
                {partners.map((partner, index) => (
                  <Card key={index} className="glass-card rounded-2xl">
                    <CardContent className="p-4 text-center">
                      ...
                      <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-1">{partner.name}</h4>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                Your privacy is paramount - learn how we protect your personal information
              </p>
            </div>
              ...
              {privacyPrinciples.map((principle, index) => (
                <Card key={index} className="glass-card rounded-2xl card-hover">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-3">{principle.title}</h3>
            ...
            <Card className="glass-card rounded-2xl mb-16">
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="space-y-2">
                    <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Account Information</h4>
                    <ul className="space-y-2">
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Name and contact details</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                      ...
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Authentication data</span>
                      </li>
                    </ul>
                  </div>
                  
                  <div className="space-y-2">
                    <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Policy Information</h4>
                    <ul className="space-y-2">
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Policy details</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Coverage information</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Premium payment history</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Claim history</span>
                      </li>
                    </ul>
                  </div>
                  
                  <div className="space-y-2">
                    <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Usage Data</h4>
                    <ul className="space-y-2">
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Device information</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                      ...
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Browser type</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Usage patterns</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Service Provision</h4>
                    <ul className="space-y-2">
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Policy creation and management</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Claims processing</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Customer support</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Transaction processing</span>
                      </li>
                    </ul>
                  </div>
                  
                  <div className="space-y-2">
                    <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Security & Compliance</h4>
                    <ul className="space-y-2">
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Fraud prevention</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Identity verification</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Regulatory reporting</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Audit trail maintenance</span>
                      </li>
                    </ul>
                  </div>
                  
                  <div className="space-y-2">
                    <h4 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Service Improvement</h4>
                    <ul className="space-y-2">
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Product enhancement</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">User experience optimization</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Aggregated analytics</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
                        <span className="text-sm text-slate-600 dark:text-slate-400">Research and development</span>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                Explore the advanced technology stack that powers our blockchain insurance platform
              </p>
            </div>
              ...
              {technicalArchitecture.map((component, index) => (
                <Card key={index} className="glass-card rounded-2xl card-hover">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-3">{component.title}</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-6">{component.description}</p>
              ...
              <div className="relative p-8 bg-white dark:bg-slate-700 rounded-xl border border-slate-200 dark:border-slate-600 overflow-hidden">
                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-3 p-4 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-center">
                    <h4 className="font-semibold text-blue-800 dark:text-blue-300">User Interface Layer</h4>
                    <div className="flex justify-center space-x-4 mt-2">
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Web App</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Mobile App</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">API</div>
                    </div>
                  </div>
                  
                  <div className="col-span-3 p-4 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg text-center">
                    <h4 className="font-semibold text-emerald-800 dark:text-emerald-300">Application Layer</h4>
                    <div className="flex justify-center space-x-4 mt-2">
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Policy Management</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Claims Processing</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Risk Assessment</div>
                    </div>
                  </div>
                  
                  <div className="p-4 bg-purple-100 dark:bg-purple-900/30 rounded-lg text-center">
                    <h4 className="font-semibold text-purple-800 dark:text-purple-300">Blockchain Layer</h4>
                    <div className="flex flex-col space-y-2 mt-2">
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Smart Contracts</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Policy NFTs</div>
                    </div>
                  </div>
                  
                  <div className="p-4 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg text-center">
                    <h4 className="font-semibold text-yellow-800 dark:text-yellow-300">Oracle Network</h4>
                    <div className="flex flex-col space-y-2 mt-2">
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Data Feeds</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">External APIs</div>
                    </div>
                  </div>
                  
                  <div className="p-4 bg-red-100 dark:bg-red-900/30 rounded-lg text-center">
                    <h4 className="font-semibold text-red-800 dark:text-red-300">Storage Layer</h4>
                    <div className="flex flex-col space-y-2 mt-2">
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">IPFS</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Encrypted DB</div>
                    </div>
                  </div>
                  
                  <div className="col-span-3 p-4 bg-slate-100 dark:bg-slate-600 rounded-lg text-center">
                    <h4 className="font-semibold text-slate-800 dark:text-slate-200">Security Layer</h4>
                    <div className="flex justify-center space-x-4 mt-2">
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Encryption</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Authentication</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Monitoring</div>
                      <div className="px-3 py-1 bg-white dark:bg-slate-800 rounded text-sm">Auditing</div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 px-4 bg-white/50 dark:bg-slate-800/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 mb-8">
            Experience the peace of mind that comes with blockchain-secured insurance
          </p>
