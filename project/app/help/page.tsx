...
export default function HelpPage() {
    ...
    general: [
      {
        ...
        answer: 'BlockSecure is a blockchain-powered insurance platform that provides transparent, efficient, and secure insurance coverage. We use smart contracts to automate policy management, claims processing, and payouts, resulting in faster service and lower costs compared to traditional insurance.'
      },
      {
        id: 'how-blockchain-insurance-works',
        question: 'How does blockchain insurance work?',
        answer: 'Blockchain insurance uses smart contracts (self-executing code) to automate insurance processes. When you purchase a policy, a smart contract is created on the blockchain. This contract contains all policy terms and conditions. When a claim is filed, the smart contract automatically verifies the claim against predefined conditions and triggers instant payouts when approved, eliminating manual processing and reducing fraud.'
      },
      {
        id: 'blockchain-vs-traditional',
        question: 'How is blockchain insurance different from traditional insurance?',
        answer: 'Blockchain insurance offers several advantages over traditional insurance: 1) Faster claims processing (minutes vs. weeks), 2) Lower premiums due to reduced overhead, 3) Complete transparency with all transactions recorded on the blockchain, 4) Automated payouts without manual intervention, 5) Immutable policy records that cannot be altered, and 6) Global accessibility 24/7.'
      },
      {
        id: 'countries-available',
        question: 'In which countries is BlockSecure available?',
        answer: 'BlockSecure is currently available in over 120 countries worldwide. However, due to regulatory requirements, some features may be limited in certain jurisdictions. Please check our Regulatory Compliance page for specific information about your country or contact our support team for detailed availability information.'
      },
      {
        id: 'get-started',
    ...
    account: [
      {
        ...
        answer: 'To create an account, click the "Get Started" button on our homepage. You\'ll need to provide your email address, create a password, and complete a brief verification process. Once verified, you\'ll be prompted to connect your crypto wallet to enable blockchain functionality.'
      },
      {
        id: 'wallet-requirements',
        question: 'What wallet do I need to use BlockSecure?',
        answer: 'BlockSecure supports most major Ethereum-compatible wallets including MetaMask, WalletConnect, Coinbase Wallet, and Trust Wallet. Your wallet is used to sign transactions, receive policy NFTs, and receive claim payouts in cryptocurrency if desired.'
      },
      {
        id: 'account-security',
        question: 'How secure is my account?',
        answer: 'We implement multiple layers of security including: 1) Two-factor authentication, 2) Advanced encryption for all sensitive data, 3) Secure wallet connection protocols, 4) Regular security audits, and 5) Fraud detection systems. We recommend enabling all security features and using a hardware wallet for maximum protection.'
      },
      {
        id: 'delete-account',
        question: 'Can I delete my account?',
        answer: 'Yes, you can delete your account at any time from your account settings. However, please note that if you have active policies, you\'ll need to cancel or transfer them first. Blockchain transactions related to your policies will remain on the blockchain as they cannot be deleted, but your personal information will be removed from our systems in accordance with our privacy policy.'
      },
      {
        id: 'change-wallet',
        question: 'Can I change my connected wallet?',
        answer: 'Yes, you can change your connected wallet through your account settings. You\'ll need to go through a verification process to ensure security. Any policy NFTs in your old wallet will need to be transferred to your new wallet, which our support team can assist with.'
      }
    ],
    policies: [
      {
        ...
        answer: 'BlockSecure offers a wide range of insurance products including: 1) Health insurance, 2) Travel insurance, 3) Agricultural/crop insurance, 4) Business insurance, 5) Property insurance, and 6) Specialty insurance products. Each category has multiple plans with different coverage levels to suit your specific needs.'
      },
      {
        id: 'policy-customization',
        question: 'Can I customize my insurance policy?',
        answer: 'Yes, most of our insurance policies can be customized to meet your specific needs. During the application process, you can select coverage limits, deductibles, and additional coverage options. Our smart contracts are designed to be flexible while maintaining the security and transparency benefits of blockchain technology.'
      },
      {
        id: 'policy-nft',
        question: 'What is a policy NFT?',
        answer: 'A policy NFT (Non-Fungible Token) is a digital representation of your insurance policy on the blockchain. It contains all the details of your coverage, terms, and conditions. The NFT serves as proof of insurance and gives you ownership of your policy. It\'s stored in your crypto wallet and can be transferred if needed.'
      },
      {
        id: 'coverage-start',
        question: 'When does my coverage start?',
        answer: 'Your coverage begins immediately after your premium payment is confirmed on the blockchain. Unlike traditional insurance that may take days to activate, our smart contracts automatically initiate your coverage as soon as the transaction is verified, typically within minutes.'
      },
      {
        id: 'policy-renewal',
        question: 'How do policy renewals work?',
        answer: 'Policy renewals can be set to automatic or manual mode. With automatic renewal, your policy will be renewed using your preferred payment method before expiration. You\'ll receive notifications 30, 15, and 5 days before renewal. For manual renewal, you\'ll need to confirm renewal before your policy expires. All renewal terms and any premium changes will be clearly communicated in advance.'
      }
    ],
    claims: [
      {
        ...
        answer: 'Filing a claim is simple: 1) Log into your account, 2) Navigate to the "Claims" section, 3) Select the policy you\'re claiming against, 4) Complete the claim form with relevant details, 5) Upload any required documentation, and 6) Submit your claim. For certain policy types with oracle integration (like weather-based crop insurance), claims may be automatically triggered without manual filing.'
      },
      {
        id: 'claim-processing-time',
        question: 'How long does claim processing take?',
        answer: 'Most claims are processed within minutes to hours, compared to days or weeks with traditional insurance. Simple claims with clear documentation may be approved and paid out instantly. More complex claims requiring additional verification typically take 24-48 hours. Our blockchain-based system eliminates unnecessary administrative delays.'
      },
      {
        id: 'claim-documentation',
        question: 'What documentation do I need for a claim?',
        answer: 'Required documentation varies by policy type and claim nature. Common documents include: 1) Incident reports, 2) Photos or videos of damage, 3) Medical records for health claims, 4) Receipts or invoices, and 5) Official reports (police, weather, etc.). All documents are securely stored using encrypted, distributed storage systems.'
      },
      {
        id: 'claim-payout-methods',
        question: 'How are claim payouts made?',
        answer: 'You can choose to receive claim payouts in cryptocurrency directly to your wallet or in fiat currency to your bank account. Crypto payouts are typically processed within minutes, while bank transfers may take 1-3 business days depending on your bank. There are no fees for cryptocurrency payouts, but bank transfers may incur standard banking fees.'
      },
      {
        id: 'claim-rejection',
        question: 'What if my claim is rejected?',
        answer: 'If your claim is rejected, you\'ll receive a detailed explanation with the specific reasons. You can appeal the decision through our Claims Appeal process, which includes review by both AI systems and human specialists. The blockchain provides complete transparency into the decision-making process, ensuring fair treatment.'
      }
    ],
    payments: [
      {
        ...
        answer: 'We accept multiple payment methods including: 1) Cryptocurrency (ETH, USDC, DAI, and others), 2) Credit/debit cards, 3) Bank transfers, and 4) PayPal. Cryptocurrency payments offer the fastest processing and lowest fees, but all methods are fully supported.'
      },
      {
        id: 'premium-frequency',
        question: 'How often do I pay premiums?',
        answer: 'You can choose from several premium payment frequencies: 1) Monthly (standard), 2) Quarterly (5% discount), 3) Semi-annually (7% discount), or 4) Annually (10% discount). You can change your payment frequency at renewal periods. Automatic payments can be set up for convenience.'
      },
      {
        id: 'missed-payment',
        question: 'What happens if I miss a payment?',
        answer: 'If you miss a payment, you\'ll receive immediate notifications. There\'s a grace period of 7 days during which your coverage remains active. After the grace period, your policy will be suspended until payment is made. Unlike traditional insurance, there are no late fees or penalties, and your policy can be instantly reactivated upon payment.'
      },
      {
        id: 'refund-policy',
        question: 'What is your refund policy?',
        answer: 'We offer a 14-day money-back guarantee on most policies if no claims have been made. If you cancel after this period, you\'ll receive a pro-rated refund for the unused portion of your premium. Refunds are processed in the same form as your original payment, typically within 1-3 business days.'
      },
      {
        id: 'crypto-volatility',
        question: 'How do you handle cryptocurrency price volatility?',
        answer: 'To protect against cryptocurrency price volatility, premium amounts are fixed in USD value at the time of purchase or renewal. If you pay in cryptocurrency, the exact amount will be calculated using real-time exchange rates at the moment of transaction. For claim payouts in cryptocurrency, you can choose to lock in the exchange rate at the time of approval or receive the equivalent value at the time of payout.'
      }
    ],
    technical: [
      {
        ...
        answer: 'Our platform is compatible with all modern devices including desktops, laptops, tablets, and smartphones. We support the latest versions of Chrome, Firefox, Safari, and Edge browsers. For mobile access, we offer native apps for iOS and Android with full functionality, including wallet integration.'
      },
      {
        id: 'wallet-connection-issues',
        question: 'I\'m having trouble connecting my wallet. What should I do?',
        answer: 'If you\'re experiencing wallet connection issues: 1) Ensure your wallet is unlocked, 2) Check that you\'re using a supported wallet, 3) Clear your browser cache, 4) Disable any ad-blockers or privacy extensions that might interfere with wallet connections, 5) Try using a different browser, or 6) Contact our technical support team for assistance.'
      },
      {
        id: 'transaction-stuck',
        question: 'My transaction is stuck or pending. What can I do?',
        answer: 'For stuck transactions: 1) Check the blockchain explorer to verify the transaction status, 2) If the transaction is pending due to low gas fees, you may need to increase the gas price in your wallet, 3) If the transaction failed, you can try again, 4) For persistent issues, contact our support team with your transaction hash for assistance.'
      },
      {
        id: 'data-export',
        question: 'Can I export my policy and claim data?',
        answer: 'Yes, you can export all your data in multiple formats including PDF, CSV, and JSON. From your account dashboard, navigate to Settings > Data Export to download your policy details, claim history, payment records, and other account information. This feature is useful for record-keeping and tax purposes.'
      },
      {
        id: 'api-integration',
        question: 'Do you offer API integration for businesses?',
        answer: 'Yes, we provide a comprehensive API for business integrations. Our RESTful API allows partners to integrate insurance offerings into their platforms, manage policies programmatically, and automate claims processing. Full documentation, SDKs for major programming languages, and sandbox testing environments are available for developers.'
      }
    ]
  };
  ...
  const selfHelpResources = [
    {
      ...
      description: 'Comprehensive articles and guides on all aspects of our platform',
      icon: FileQuestion,
      link: '/knowledge-base'
    },
    {
    ...
    },
    {
      ...
      description: 'Connect with other users to share experiences and solutions',
      icon: Users,
      link: '/community'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {searchTerm && filteredFaqs.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-2">No results found</h3>
              <p className="text-slate-600 dark:text-slate-400 mb-6">
                We couldn't find any answers matching "{searchTerm}"
              </p>
              <Button onClick={() => setSearchTerm('')} className="gradient-accent text-white floating-button">
                Clear Search
              </Button>
            </div>
          )}
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            {filteredFaqs.map((faq) => (
              <Card key={faq.id} className="glass-card rounded-2xl overflow-hidden">
                <div
                  className="p-6 cursor-pointer flex justify-between items-center"
                  onClick={() => toggleQuestion(faq.id)}
                >
                  <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100">{faq.question}</h3>
            ...
            <div className="lg:col-span-1 space-y-6">
              <Card className="glass-card rounded-2xl">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-6">Contact Methods</h3>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-medium text-slate-800 dark:text-slate-100 mb-1">Live Chat</h4>
                        <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">Fastest response time</p>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-medium text-slate-800 dark:text-slate-100 mb-1">Email Support</h4>
                        <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">Response within 24 hours</p>
                        <a href="mailto:support@blocksecure.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-medium text-slate-800 dark:text-slate-100 mb-1">Phone Support</h4>
                        <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">For urgent matters</p>
                        <a href="tel:+18005551234" className="text-purple-600 dark:text-purple-400 hover:underline">
                          +1 (800) 555-1234
                        </a>
                      </div>
                    </div>
              ...
              <Card className="glass-card rounded-2xl">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-6">Support Hours</h3>
                  
                  <div className="space-y-4">
                    {supportHours.map((schedule, index) => (
                      <div key={index} className="flex justify-between items-center">
                        <span className="font-medium text-slate-700 dark:text-slate-300">{schedule.day}</span>
            ...
            <div className="lg:col-span-2">
              <Card className="glass-card rounded-2xl">
                <CardContent className="p-8">
                  <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-6">Send Us a Message</h3>
                  ...
                  <form className="space-y-6">
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <label htmlFor="consent" className="text-sm text-slate-600 dark:text-slate-400">
                        I agree to the processing of my personal data in accordance with the <a href="/privacy-policy" className="text-emerald-600 dark:text-emerald-400 hover:underline">Privacy Policy</a>
                      </label>
                    </div>
      ...
      {/* Troubleshooting Guides */}
      <section id="guides" className="py-20 px-4 bg-white/50 dark:bg-slate-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-800 dark:text-slate-100">
              Troubleshooting Guides
              ...
              <Card key={index} className="glass-card rounded-2xl card-hover">
                <CardContent className="p-8">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100">{guide.title}</h3>
                  </div>
              ...
              <Link key={index} href={resource.link}>
                <Card className="glass-card rounded-2xl h-full card-hover">
                  <CardContent className="p-6 flex flex-col items-center text-center h-full">
                    ...
                    <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">{resource.title}</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-4 flex-grow">{resource.description}</p>
                    <Button variant="outline" className="floating-button w-full">
                      Explore
